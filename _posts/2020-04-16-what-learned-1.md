...
Yeah, I'm not really sure either why I asked him if I could fix something which took one line of code to change and caused our build to fail, and would thus block any other engineers from working on the product. The need was there and the fix was within my capability, but I still felt a need to ask for permission. That made me stop and think for a second, and realized the following two improvement areas I needed to work on from my internship:
